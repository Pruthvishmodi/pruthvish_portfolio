      ...
      layout: [
        {
          ...
          expertise: {
            ...
            stats: [
              { number: '9', label: 'YEARS OF EXPERIENCE', color: 'primary' },
              { number: '15', label: 'COMPLETED PROJECTS', color: 'secondary' },
              { number: '50', label: 'CORPORATE TRAINING', color: 'tertiary' },
              { number: '300', label: 'HOURS OF ONLINE TRAINING', color: 'primary' },
            ],
            cards: [
              {
          ...
          workExperience: {
            ...
            timeline: [
              ...
              },
              {
                ...
                duration: '',
                role: 'Senior Software Engineer',
                description: '• Solas Tank Monitoring: Real-time marine IoT system (Node.js, WebSockets, MySQL) — 10K readings/min, 99.9% uptime\nStack: Node.js, WebSockets, MySQL',
                color: 'tertiary',
              },
              {
                ...
                description: '• ESG Konnect: Sustainability consulting tool (React.js, Chart.js, MySQL) with interactive dashboards for ESG tracking\nStack: React.js, Chart.js, MySQL',
                color: 'secondary',
              },
            ],
          },
